...
// Constructor
Item::Item(uint8_t posX, uint8_t posY, string NAME, string DESC, string TYPE, vector<short> COLOR, string DAM, u_int16_t HIT, u_int16_t DODGE, u_int16_t DEF, u_int16_t WEIGHT, u_int16_t SPEED, string ATTR, u_int16_t VAL, bool ART, u_int8_t RRTY, cell_t previousCell, bool  eligibility, bool equipped)
...
string Item::getAttribute() const { return ATTR; }
...
void Item::setAttribute(string attribute) { ATTR = attribute; }
